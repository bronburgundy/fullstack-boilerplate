...
function getKicks() {
  return _superagent2.default.get('/api/v1/shoes').then(function (res) {
    return res.body;
  }).catch(function (err) {
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _apiClient.getKicks)().then(function (kicks) {
        _this2.setState({ kicks: kicks });
      });
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'ul',
          null,
          this.state.kicks.map(function (kick) {
            return _react2.default.createElement(
              'li',
              { key: kick.brand },
              kick.brand
